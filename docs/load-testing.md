...
The request lists mirror the page composables in `web/app`, including their conditions: the champion's static
data is requested only once the champion answered with its patch, and duo trios
