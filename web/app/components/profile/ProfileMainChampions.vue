    ...
    <ul class="flex flex-col divide-y divide-default/40 overflow-hidden rounded-lg bg-elevated/40">
      ...
      >
        <NuxtLink
          ...
          class="flex items-center gap-3 px-3 py-2 transition-colors hover:bg-elevated/70 focus-visible:bg-elevated/70 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-primary"
        >
          <SkeletonImage
