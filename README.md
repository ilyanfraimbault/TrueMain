...
- [`docs/load-testing.md`](docs/load-testing.md) — load testing preprod with k6 from GitHub Actions: scenarios, what a simulated visitor does, the rate-limit caveat, how to read the summary.
