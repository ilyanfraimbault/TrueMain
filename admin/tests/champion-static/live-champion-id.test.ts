...
// Mirror of `web/tests/champion-static/live-champion-id.test.ts` (#1226).
// `shared/utils/ddragon.ts` is a synchronised copy in both apps, so the #966
// floor has to be locked on both sides — it was pinned on the web side only,
