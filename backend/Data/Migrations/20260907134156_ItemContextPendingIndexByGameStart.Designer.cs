...
namespace Data.Migrations
{
    ...
    [Migration("20260907134156_ItemContextPendingIndexByGameStart")]
    partial class ItemContextPendingIndexByGameStart
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Data.Entities.ChampionItemContextTotal", b =>
                {
                    ...
                    b.HasIndex("Patch", "ChampionId", "Position", "Slot", "ParentItemId", "Axis", "Bucket")
                        .IsUnique()
            ...
            modelBuilder.Entity("Data.Entities.ChampionItemContextVerdict", b =>
                {
                    ...
                    b.HasIndex("Patch", "ChampionId", "Position", "Slot", "ParentItemId", "ItemId")
                        .IsUnique()
            ...
            modelBuilder.Entity("Data.Entities.Match", b =>
                {
                    ...
                    b.Property<bool>("TimelineSnapshotsPruned")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false);
                    ...
                    b.HasIndex(new[] { "QueueId", "GameStartTimeUtc" }, "IX_matches_item_context_pending")
