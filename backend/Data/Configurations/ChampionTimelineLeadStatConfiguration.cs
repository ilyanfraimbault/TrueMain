...
public sealed class ChampionTimelineLeadStatConfiguration : IEntityTypeConfiguration<ChampionTimelineLeadStat>
{
    public void Configure(EntityTypeBuilder<ChampionTimelineLeadStat> entity)
    {
        entity.ToTable("champion_timeline_lead_stats");
        ...
        entity.Property(e => e.TotalCsDiff).IsRequired();
        entity.Property(e => e.TotalKillsDiff).IsRequired();
        entity.Property(e => e.TotalLevelDiff).IsRequired();
        entity.Property(e => e.TotalXpDiff).IsRequired();
